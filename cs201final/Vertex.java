...
public class Vertex<T> implements Comparable<Vertex<T>> {
  ...
  public Vertex(T lb) {
    ...
    this.distance = Double.POSITIVE_INFINITY;//what is this?
  }

  // this is the comparable method for the weighed method. 

  public int compareTo(Vertex<T> side){
    if(this.getDistance() < side.getDistance()) {
      return -1;
    }
    else if(this.getDistance() > side.getDistance()){
      return 1;
    }
    else{
      return 0;
